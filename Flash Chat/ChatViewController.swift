...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Remove separator between sender
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var name1 = messageArray[indexPath.row].sender
        
        cell.messageBody.text = messageArray[indexPath.row].messageBody
        cell.senderUsername.text = name1
    ...
    // -> To get trigger when some activity is detected inside textfield
    func textFieldDidBeginEditing(_ textField: UITextField) {
        //Change value constraint message view to 308 -> ori value from view is 50 + 258
        //Actually to recognize keyboard height, you can use method
        //Used for refresh the layout position and constraint on view
        //Closure
    ...
    func retrieveMessage(){
        ...
        messageDB.observe(.childAdded) { (snapshot) in
            ...
            messageModel.messageBody = messageText
            messageModel.sender = messageSender
...
//            navigationController?.popToRootViewController(animated: true)
            ...
            print("Error there's a problem sign out!")
        }
